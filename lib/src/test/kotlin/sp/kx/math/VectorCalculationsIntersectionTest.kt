...
internal class VectorCalculationsIntersectionTest {
    ...
    fun getIntersectionCollinearTest() {
        ...
        val actual = ab.getIntersection(cd)
        Assertions.assertEquals(actual, ab.getIntersection(c = cd.start, d = cd.finish))
        Assertions.assertEquals(actual, getIntersection(a = ab.start, b = ab.finish, cd = cd))
