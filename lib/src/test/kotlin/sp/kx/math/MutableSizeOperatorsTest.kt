...
internal class MutableSizeOperatorsTest {
    @Test
    fun timesAssignTest() {
    ...
    fun plusAssignOffsetTest() {
        ...
        val delta = 0.00000001
        listOf(
            offsetOf(-1.2, -3.4) to sizeOf(0.0, 0.0),
            offsetOf(-1.2, 0.0) to sizeOf(0.0, 3.4),
            offsetOf(0.0, -3.4) to sizeOf(1.2, 0.0),
            offsetOf(0.0, 0.0) to sizeOf(1.2, 3.4),
            offsetOf(0.0, 1.0) to sizeOf(1.2, 4.4),
            offsetOf(1.0, 0.0) to sizeOf(2.2, 3.4),
            offsetOf(1.0, 1.0) to sizeOf(2.2, 4.4),
            offsetOf(2.8, 0.6) to sizeOf(4.0, 4.0),
